...
UPDATER_IMAGE_PARTS += $(shell [ -f $(MACHINEDIR)/rootconf/sysroot-lib-onie/onie-blkdev-common ] && \
			echo $(MACHINEDIR)/rootconf/sysroot-lib-onie/onie-blkdev-common || \
			echo $(ROOTCONFDIR)/x86_64/sysroot-lib-onie/onie-blkdev-common )
